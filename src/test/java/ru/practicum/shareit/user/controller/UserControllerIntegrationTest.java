...
public class UserControllerIntegrationTest {
    ...
    @Test
    @SneakyThrows
    public void addUserWhenUserNameIsNotValidThrowException() {
        userDto.setName("");
    ...
    @Test
    @SneakyThrows
    public void addUserWhenUserMailIsBlankThrowException() {
        userDto.setEmail("");
    ...
    @Test
    @SneakyThrows
    public void addUserWhenUserMailIsNotValidThrowException() {
        userDto.setEmail("mailmail");
    ...
    @Test
    @SneakyThrows
    public void updateUserWhenNameIsBlankReturnStatusBadRequest() {
        mvc.perform(post(URL)
                        .content(mapper.writeValueAsString(userDto))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    @SneakyThrows
    public void updateUserWhenNameIsNullReturnOldUser() {
        ...
        mvc.perform(post(URL)
                ...
                .andExpect(jsonPath("$.id", is((int) userId)))
                .andExpect(jsonPath("$.email", is(userDto.getEmail())))
                .andExpect(jsonPath("$.name", is(oldName)));
    ...
    @Test
    @SneakyThrows
    public void updateUserWhenEmailIsBlankReturnStatusBadRequest() {
        mvc.perform(post(URL)
                        .content(mapper.writeValueAsString(userDto))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    @SneakyThrows
    public void updateUserWhenEmailIsNotValidReturnStatusBadRequest() {
        mvc.perform(post(URL)
                        .content(mapper.writeValueAsString(userDto))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    @SneakyThrows
    public void updateUserWhenEmailIsNullReturnOldUser() {
        ...
        mvc.perform(post(URL)
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id", is((int) userId)))
                .andExpect(jsonPath("$.email", is(oldEmail)))
                .andExpect(jsonPath("$.name", is(userDto.getName())));
